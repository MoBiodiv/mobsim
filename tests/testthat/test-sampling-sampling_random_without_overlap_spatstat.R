test_that("warns if there is overlap", {
   expect_warning(
      sampling_random_spatstat(n_quadrats = 10L,
                               xmin = 0, xmax = 1,
                               ymin = 0, ymax = 1,
                               min_dist = 1
      )
...
test_that("classes are correct", {
   expect_type(
      sampling_random_spatstat(n_quadrats = 2L,
                               xmin = 0, xmax = 1,
                               ymin = 0, ymax = 1,
...
test_that("dimensions are correct", {
   n_quadrats = 5L
   xy_dat <- sampling_random_spatstat(n_quadrats = n_quadrats,
                                      xmin = 0, xmax = 1,
                                      ymin = 0, ymax = 1,
                                      min_dist = sqrt(2 * 0.01)
   )
...
test_that("samples are within range", {
   ...
   xy_dat <- sampling_random_spatstat(n_quadrats = 2L,
                                      xmin = xmin, xmax = xmax,
                                      ymin = ymin, ymax = ymax,
...
test_that("seed parameter is respected", {
   ...
   expect_equal(
      sampling_random_spatstat(n_quadrats = 5L,
                               xmin = 0, xmax = 1,
                               ymin = 0, ymax = 1,
                               min_dist = sqrt(2 * 0.01),
                               seed = 42L),
