...
```{r}
sim1 <- sim_sad(s_pool = 100, n_local = 1000, cv_abund = 0.0)
sim2 <- sim_sad(s_pool = 100, n_local = 1000, cv_abund = 1.0)
sim3 <- sim_sad(s_pool = 100, n_local = 1000, cv_abund = 2.0)
```
...
```{r}
sim1a <- sim_sad(s_pool = 100, n_local = 1000, cv_abund = 0.0, fix_s_local = T)
sim2a <- sim_sad(s_pool = 100, n_local = 1000, cv_abund = 1.0, fix_s_local = T)
sim3a <- sim_sad(s_pool = 100, n_local = 1000, cv_abund = 2.0, fix_s_local = T)
```
...
```{r}
abund1 <- sort(sim1, decreasing = T)
abund2 <- sort(sim2, decreasing = T)
abund3 <- sort(sim3, decreasing = T)
```
...
```{r}
abund1 <- sim_sad(s_pool = 10, n_local = 100)
...
```{r}
com3 <- sim_poisson_community(s_pool = 100, n_local = 500)
```

### Thomas process

```{r}
com4 <- sim_thomas_community(s_pool = 100, n_local = 500, sigma = 0.05)
```
