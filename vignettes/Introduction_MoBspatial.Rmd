...
```{r}
sim1 <- sim_sad(s_pool = 100, n_sim = 1000, cv_abund = 0.0)
sim2 <- sim_sad(s_pool = 100, n_sim = 1000, cv_abund = 1.0)
sim3 <- sim_sad(s_pool = 100, n_sim = 1000, cv_abund = 2.0)
```
...
```{r}
sim1a <- sim_sad(s_pool = 100, n_sim = 1000, cv_abund = 0.0, fix_s_sim = T)
sim2a <- sim_sad(s_pool = 100, n_sim = 1000, cv_abund = 1.0, fix_s_sim = T)
sim3a <- sim_sad(s_pool = 100, n_sim = 1000, cv_abund = 2.0, fix_s_sim = T)
```
