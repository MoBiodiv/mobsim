...
divar1 <- DivAR(sim_dat1, prop.A = subplot_size)
head(divar1)
```
Plot SAR and EAR

```{r, fig.width = 5, fig.height = 5}
plot(meanSpec ~ propArea, data = divar1, type = "b", ylim = c(0, 30),
     xlab = "Proportion of area", ylab = "No. of species")
lines(meanEnd ~ propArea, data = divar1, type = "b", col = 2)
...
```{r,fig.width=5, fig.height=5}
dd <- dist_decay(sim_dat1, prop.A = 0.05, nsamples = 30, method = "jaccard")
head(dd)
