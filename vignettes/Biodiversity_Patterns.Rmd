...
```{r}
library(mobsim)
sim_dat1 <- sim_thomas_community(s_pool = 30,  n_sim = 500, sad_type = "lnorm",
...
As indicated by the name of the package the main strengths of mobsim are the
simulation and analysis of *spatial* biodiversity patterns. In the following all
functions for spatial pattern evaluation included in mobsim are introduced.
...
```{r,fig.width=5, fig.height=5}
dd1 <- dist_decay(sim_dat1, prop_area = 0.05, n_samples = 30, method = "jaccard")
head(dd1)
