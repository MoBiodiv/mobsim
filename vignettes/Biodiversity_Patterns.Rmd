...
First, we generate community data by simulating 1000 individuals from 30 species
...
from a focal individual always the closest neighbour individual is sampled and the
...
Keil et al. 2015). For the evaluation of SAR and EAR using mobsim a vector
...
The function `dist_decay` tries to distribute a subplots with user-defined size and
number in the community and calculates all pairwise similarities. 
