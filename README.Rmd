...
[![R-CMD-check](https://github.com/AlbanSagouis/mobsim/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/AlbanSagouis/mobsim/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
```
```{r, fig.width=8, fig.height=4.5, eval=F}
par(mfrow = c(1,2))
plot(comm_rand)
plot(comm_agg)
```
